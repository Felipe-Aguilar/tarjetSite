...
const BusquedaNivel3Rango = async (nivel, latitud, longitud) => {
    ...
    const response = await fetch(`https://souvenir-site.com/WebTarjet/APIDirectorio/BuscaXCategoria?Categoriaid=${nivel}&Latitud=${latitud}&Longitud=${longitud}&Radio=3000`, {
        method: 'GET',
        mode: 'cors',
        cache: 'no-store',
        headers: {
